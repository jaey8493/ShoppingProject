...
<body>
	...
	<form action="orderproc_admin.jsp" name="detailFrm" method="get">
		<table style="width: 90%" border="1">
			...
			<tr>
				<td colspan="4">총 결재 금액 : <%=Integer.parseInt(order.getQuantity()) * Integer.parseInt(product.getPrice())%>
				</td>
			</tr>
			<tr>
	 	...
	 	/
	 	<input style="background:gold;" type="button" value="삭 제" onclick="orderDelete(this.form)">
